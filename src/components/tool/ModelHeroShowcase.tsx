    ...
    <section className={cn("max-w-[1360px] mx-auto px-4 py-8 section-modelHeroShowcase", className)}>
      <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-3">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 lg:grid-rows-6 gap-3 min-h-[500px] lg:min-h-0">
          ...
          <div className="lg:contents sm:contents flex flex-col gap-3 h-full">
            <PosterItem poster={posters[0]} className="lg:row-span-4 sm:row-span-4 h-full" />
            <PosterItem poster={posters[1]} className="lg:row-span-2 sm:row-span-2 h-full" />
          </div>
          
          {/* Column 2: Small (2), Big (4) */}
          <div className="lg:contents sm:contents flex flex-col gap-3 h-full">
            <PosterItem poster={posters[2]} className="lg:row-span-2 sm:row-span-2 h-full" />
            <PosterItem poster={posters[3]} className="lg:row-span-4 sm:row-span-4 h-full" />
          </div>
          
          {/* Column 3: Big (4), Small (2) */}
          <div className="lg:contents sm:contents flex flex-col gap-3 h-full">
            <PosterItem poster={posters[4]} className="lg:row-span-4 sm:row-span-4 h-full" />
            <PosterItem poster={posters[5]} className="lg:row-span-2 sm:row-span-2 h-full" />
          </div>
          
          {/* Column 4: Small (2), Big (4) */}
          <div className="lg:contents sm:contents flex flex-col gap-3 h-full">
            <PosterItem poster={posters[6]} className="lg:row-span-2 sm:row-span-2 h-full" />
            <PosterItem poster={posters[7]} className="lg:row-span-4 sm:row-span-4 h-full" />
          </div>
        </div>
      </div>
    </section>

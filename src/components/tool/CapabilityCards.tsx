...
const Mockup = ({ type }: MockupProps) => {
  ...
  if (type === 'multi') {
    return (
      <div className="relative w-full h-full flex flex-col items-center justify-center p-0 gap-2 group-hover:scale-[1.05] transition-transform duration-500">
        <div className="relative w-[92%] h-[92%] flex flex-col items-center justify-center gap-2">
          {/* Prompt plate */}

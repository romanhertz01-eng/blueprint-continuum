  ...
  return (
    <section className={cn("w-full bg-[#0E0C0C] py-20 text-[#F7EEE8] section-priceCompare", className)}>
      <div className="max-w-[1200px] mx-auto px-4">
        ...
        <div className="bg-[#141211] border border-[#2D2420] rounded-[24px] p-7 md:p-14">
          <div className="flex flex-col md:flex-row items-center gap-10 md:gap-20">
            ...
            <div className="w-full md:w-[56%] flex flex-col gap-4 relative">
              ...
              <div className="bg-[#1A1817] border border-[#2D2420] rounded-2xl p-7 md:p-8">
                ...
                <div className="pt-4 border-t border-[#2D2420]/50 flex justify-between items-center">
              ...
              {/* Lower Card: ERA2 */}
              <div className="bg-[#1A1817] border border-[#FFB27A]/40 rounded-2xl p-7 md:p-8 relative overflow-hidden">

...
export function EditorialBanner({ label, title, subtitle, ctaLabel, ctaHref, bgSrc }: EditorialBannerProps) {
  return (
    <section className="col-span-full w-full h-[320px] md:h-[380px] rounded-[28px] overflow-hidden relative mb-8 group">
      {/* Background Image */}
      <img 
        src={bgSrc} 
        alt={title} 
      ...
      <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-between items-start">
        {/* Chip Label */}
        <div className="px-3 py-1.5 rounded-full bg-primary text-white text-[11px] font-black uppercase tracking-wider shadow-lg shadow-primary/30">
          {label}
        </div>

...
export const promptItems: PromptItem[] = [
  ...
  },
  {
    ...
    body: {
      ...
      howToChange: 'Попробуйте сменить локацию на тихий сельский пейзаж или школьный двор, сохранив погодный эффект. Также можно добавить одинокий силуэт с прозрачным зонтом для усиления лирического настроения в стиле Макото Синкая.',
